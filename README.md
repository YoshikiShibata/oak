...
-v option shows both names of test class and test method. `-run=` option accept an regular expression for filtering test methods. For example, `-run=.` will run all tests.
